...
parser.add_argument('--filter', default='all', choices=['all', 'seen', 'unseen'], help='')
...
if __name__ == "__main__":
    ...
    with open(args.sample_file, 'r') as sample_reader, \
        ...
        if args.ref_type == 'e2e':
            ...
            reference_writers = [ open(os.path.join(args.output_ref_file, f'reference{fid}'), 'w', encoding='utf8') for fid in range(0, args.ref_num) ] 
