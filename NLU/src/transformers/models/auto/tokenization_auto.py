...
if is_sentencepiece_available():
    ...
    from ..deberta_densenet.tokenization_deberta_densenet import DebertaDenseNetTokenizer
...
TOKENIZER_MAPPING = OrderedDict(
    [
        ...
        (DebertaDenseNetConfig, (DebertaDenseNetTokenizer, None)),
